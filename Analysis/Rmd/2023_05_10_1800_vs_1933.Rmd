...
I also remove some TEs because we are using all the reads, but this can cause misleading reasults if the reads map on a single part of the TE, like streteches of As in the LINEs, the removed TEs are picked after a screening of the deviaTE_plots.
...
# Conclusions
Three LTR-retrotransposons invaded in the $19^{th}$ century: 412, Opus and Blood.
