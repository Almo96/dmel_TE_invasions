...
plot(gg_1A_log_Lau)
ggsave("/Volumes/INTENSO/deviaTE_plots/Paper/Figure_1/Fig_1A_2.png", gg_1A_log_Lau, width = 10, height = 4, dpi = 300)

#Combined
gg_1A <- ggarrange(gg_1A_log_Har_s, gg_1A_log_Lau, ncol = 1, nrow = 2)
plot(gg_1A)
ggsave("/Volumes/INTENSO/deviaTE_plots/Paper/Figure_1/Fig_1A.png", gg_1A, width = 10, height = 8, dpi = 300)
